...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(va_htp_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(va_htp_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(va_htp_hwinfo)(remote_handle64 _h, uint32* arch, uint32* hvx_units, uint32* vtcm_bytes) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(va_htp_map_arena)(remote_handle64 _h, uint32 fd, uint32 size) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(va_htp_unmap_arena)(remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(va_htp_execute)(remote_handle64 _h, uint32 opcode, uint32 lanes, const uint8* parameters, int parametersLen, const uint8* input0, int input0Len, const uint8* input1, int input1Len, uint8* output, int outputLen, uint64* elapsed_cycles) __QAIC_HEADER_ATTRIBUTE;
#ifndef va_htp_URI
#define va_htp_URI "file:///libva_htp_skel.so?va_htp_skel_handle_invoke&_modver=1.0"
#endif /*va_htp_URI*/
#ifdef __cplusplus
}
#endif
