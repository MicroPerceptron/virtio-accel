#ifndef _VA_HTP_SKEL_H
#define _VA_HTP_SKEL_H
#include "va_htp.h"
...
extern "C" {
#endif
_ATTRIBUTE_VISIBILITY uint32_t va_htp_skel_handle_invoke_qaic_version = 10051;
_ATTRIBUTE_VISIBILITY char va_htp_skel_handle_invoke_uri[63+1]="file:///libva_htp_skel.so?va_htp_skel_handle_invoke&_modver=1.0";
static __inline int _skel_method(int (*_pfn)(remote_handle64, uint32, uint32, const uint8*, int, const uint8*, int, const uint8*, int, uint8*, int, uint64*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   ...
   _QAIC_ASSERT(_nErr, (_pra + ((4 + 2) + (((0 + 0) + 0) + 0))) <= _praEnd);
   ...
   _praIn = (_pra + 1);
   _QAIC_ASSERT(_nErr, ((_praIn[0].buf.nLen / 1)) >= (size_t)(_in2Len[0]));
   _in2[0] = _praIn[0].buf.pv;
   _COPY(_in3Len, 0, _primIn, 12, 4);
   _QAIC_ASSERT(_nErr, ((_praIn[1].buf.nLen / 1)) >= (size_t)(_in3Len[0]));
   _in3[0] = _praIn[1].buf.pv;
   _COPY(_in4Len, 0, _primIn, 16, 4);
   _QAIC_ASSERT(_nErr, ((_praIn[2].buf.nLen / 1)) >= (size_t)(_in4Len[0]));
   _in4[0] = _praIn[2].buf.pv;
   _COPY(_rout5Len, 0, _primIn, 20, 4);
   _praROut = (_praIn + _numIn[0] + 1);
   _QAIC_ASSERT(_nErr, ((_praROut[0].buf.nLen / 1)) >= (size_t)(_rout5Len[0]));
   _rout5[0] = _praROut[0].buf.pv;
   _TRY(_nErr, _pfn(_h, (uint32)*_in0, (uint32)*_in1, (const uint8*)*_in2, (int)*_in2Len, (const uint8*)*_in3, (int)*_in3Len, (const uint8*)*_in4, (int)*_in4Len, (uint8*)*_rout5, (int)*_rout5Len, (uint64*)_rout6));
   _COPY(_primROut, 0, _rout6, 0, 8);
   _QAIC_CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_1(int (*_pfn)(remote_handle64), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd = 0;
   int _nErr = 0;
   _praEnd = ((_pra + REMOTE_SCALARS_INBUFS(_sc)) + REMOTE_SCALARS_OUTBUFS(_sc) + REMOTE_SCALARS_INHANDLES(_sc) + REMOTE_SCALARS_OUTHANDLES(_sc));
...
static __inline int _skel_method_2(int (*_pfn)(remote_handle64, uint32, uint32), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd = 0;
   uint32_t _in0[1] = {0};
   uint32_t _in1[1] = {0};
   uint32_t* _primIn= 0;
...
static __inline int _skel_method_3(int (*_pfn)(remote_handle64, uint32*, uint32*, uint32*), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd = 0;
   uint32_t _rout0[1] = {0};
   uint32_t _rout1[1] = {0};
   uint32_t _rout2[1] = {0};
   ...
   _TRY(_nErr, _pfn(_h, (uint32*)_rout0, (uint32*)_rout1, (uint32*)_rout2));
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(va_htp_skel_handle_invoke)(remote_handle64 _h, uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc)){
      case 0:
      return _skel_method_5(__QAIC_IMPL(va_htp_open), _sc, _pra);
      case 1:
      return _skel_method_4(__QAIC_IMPL(va_htp_close), _sc, _pra);
      case 2:
      return _skel_method_3(__QAIC_IMPL(va_htp_hwinfo), _h, _sc, _pra);
      case 3:
      return _skel_method_2(__QAIC_IMPL(va_htp_map_arena), _h, _sc, _pra);
      case 4:
      return _skel_method_1(__QAIC_IMPL(va_htp_unmap_arena), _h, _sc, _pra);
      case 5:
      return _skel_method(__QAIC_IMPL(va_htp_execute), _h, _sc, _pra);
   }
