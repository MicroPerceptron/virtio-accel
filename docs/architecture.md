...
signed-zero, infinity, and NaN preservation — has executed its full corpus on Apple M4 with the
gate's denormal clause experimentally relaxed; ANV/RADV runs against the shipped gate are owed.
