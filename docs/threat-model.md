...
check resource accounting after every action. The TOSA target mutates a stable graph, traverses
all safe views, decodes stable attributes, and runs target-semantic validation. Another target drives the reference guest client
