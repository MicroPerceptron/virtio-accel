...
| [`virtio-accel-vulkan`](api/virtio_accel_vulkan/index.html) | `std` | Vendor-neutral Vulkan 1.3 compute backend with the shared FP32 tier plus the native FP16 and FP8 tiers |
